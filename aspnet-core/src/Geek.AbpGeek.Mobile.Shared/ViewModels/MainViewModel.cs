...
using MvvmHelpers;
using Geek.AbpGeek.Authorization.Users.Profile;
using Geek.AbpGeek.Authorization.Users.Profile.Dto;
using Geek.AbpGeek.Commands;
using Geek.AbpGeek.Core.Threading;
using Geek.AbpGeek.Models.NavigationMenu;
using Geek.AbpGeek.Services.Navigation;
using Geek.AbpGeek.ViewModels.Base;
using Plugin.Media;
...
using Geek.AbpGeek.ApiClient;
using Geek.AbpGeek.Controls;
using Geek.AbpGeek.Dto;
using Geek.AbpGeek.Extensions;
using Geek.AbpGeek.Localization;
using Geek.AbpGeek.UI;
using Geek.AbpGeek.UI.Assets;
using Geek.AbpGeek.Views;
using DependencyResolver = Geek.AbpGeek.Core.Dependency.DependencyResolver;

namespace Geek.AbpGeek.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "AbpGeek";
