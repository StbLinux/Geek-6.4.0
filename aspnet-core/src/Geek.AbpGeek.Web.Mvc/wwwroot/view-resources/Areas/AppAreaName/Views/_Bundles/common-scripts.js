...
(function ($) {
    ...
    app.UserNotificationHelper = (function () {
        ...
        return function () {
            ...
            /* Example:
            abp.notifications.messageFormatters['Geek.AbpGeek.MyNotificationDataType'] = function(userNotification) {
...
(function () {
    ...
    var appLocalizationSource = abp.localization.getSource('AbpGeek');
