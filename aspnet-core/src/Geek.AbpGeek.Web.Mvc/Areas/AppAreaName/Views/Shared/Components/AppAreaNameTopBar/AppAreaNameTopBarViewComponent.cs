...
namespace Geek.AbpGeek.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTopBar
{
    public class AppAreaNameTopBarViewComponent : AbpGeekViewComponent
    {
