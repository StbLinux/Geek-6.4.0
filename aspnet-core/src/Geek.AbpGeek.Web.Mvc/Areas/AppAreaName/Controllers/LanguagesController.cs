...
using Geek.AbpGeek.Web.Areas.AppAreaName.Models.Languages;
...
namespace Geek.AbpGeek.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : AbpGeekControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = AbpGeekConsts.LocalizationSourceName;
            }
