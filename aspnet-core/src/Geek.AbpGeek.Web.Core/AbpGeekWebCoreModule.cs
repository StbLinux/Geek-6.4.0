...
using Geek.AbpGeek.Web.Authentication.JwtBearer;
using Geek.AbpGeek.Web.Authentication.TwoFactor;
using Geek.AbpGeek.Web.Chat.SignalR;
using Geek.AbpGeek.Web.Configuration;

namespace Geek.AbpGeek.Web
{
    [DependsOn(
    ...
    public class AbpGeekWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AbpGeekWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(AbpGeekApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AbpGeekWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(AbpGeekWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
