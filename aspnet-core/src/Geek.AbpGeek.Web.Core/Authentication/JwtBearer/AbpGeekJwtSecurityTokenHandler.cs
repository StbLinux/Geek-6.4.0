...
namespace Geek.AbpGeek.Web.Authentication.JwtBearer
{
    public class AbpGeekJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public AbpGeekJwtSecurityTokenHandler()
        {
