...
{
    public class AbpGeekDbContext : AbpZeroDbContext<Tenant, Role, User, AbpGeekDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public AbpGeekDbContext(DbContextOptions<AbpGeekDbContext> options)
            : base(options)
        {
