...
namespace Geek.AbpGeek.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : AbpGeekServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Geek.AbpGeek", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
