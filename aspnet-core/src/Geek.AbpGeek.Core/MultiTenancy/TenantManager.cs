...
using Geek.AbpGeek.MultiTenancy.Demo;
...
namespace Geek.AbpGeek.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(AbpGeekConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
