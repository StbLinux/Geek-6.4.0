...
namespace Geek.AbpGeek.Web.Public.Startup
{
    ...
    public class AbpGeekWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AbpGeekWebFrontEndModule(IHostingEnvironment env, AbpGeekEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AbpGeekWebFrontEndModule).GetAssembly());
        }
    }
}
