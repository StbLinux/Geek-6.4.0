...
using Geek.AbpGeek.Auditing.Exporting;
using Geek.AbpGeek.Authorization;
using Geek.AbpGeek.Authorization.Users;
using Geek.AbpGeek.Dto;
using EntityHistoryHelper = Geek.AbpGeek.EntityHistory.EntityHistoryHelper;

namespace Geek.AbpGeek.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : AbpGeekAppServiceBase, IAuditLogAppService
    {
