...
using Geek.AbpGeek.DemoUiComponents.Dto;

namespace Geek.AbpGeek.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : AbpGeekAppServiceBase, IDemoUiComponentsAppService
    {
