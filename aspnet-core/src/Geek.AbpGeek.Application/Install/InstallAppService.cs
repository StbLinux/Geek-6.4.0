...
namespace Geek.AbpGeek.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : AbpGeekAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<AbpGeekDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(AbpGeekConsts.ConnectionStringName).Value.ToString();
        }
